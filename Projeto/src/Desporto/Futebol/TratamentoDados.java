 ...
 */
public class TratamentoDados implements Serializable{
     ...
     */
    public TratamentoDados lerFicheiroObjeto(String filename) throws IOException, ClassNotFoundException {
        File f = new File("inputFiles/"+filename);
        FileInputStream fis = new FileInputStream(f);
        ObjectInputStream ois = new ObjectInputStream(fis);
        TratamentoDados cd;
        if((cd = (TratamentoDados) ois.readObject())!=null){
            ois.close();
            return cd;
        }
        ois.close();
